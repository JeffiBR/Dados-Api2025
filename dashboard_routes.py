...
# dashboard_routes.py - Novas rotas para o dashboard
...
async def get_products_by_market(
    ...
    try:
        ...
        # Agrupar por mercado e contar produtos únicos
        ...
        # Ordenar por total de produtos (decrescente)
...
async def get_recent_collections(
    ...
    try:
        ...
        # Adicionar informações dos mercados para cada coleta
...
async def get_market_stats(
    ...
    try:
        ...
        # Total de produtos (últimos 30 dias)
...
async def get_barcode_analysis(
    ...
    try:
        ...
        # Retornar dados em formato simples para o frontend
        results = []
        for item in data:
            results.append({
...
async def get_collection_analysis(
    ...
    try:
        # Buscar informações dos mercados selecionados
        markets_response = await asyncio.to_thread(
            supabase.table('supermercados')
            .select('cnpj, nome, endereco')
        ...
        # Buscar dados de produtos no período
        ...
        # Processar estatísticas por mercado
        market_stats = []
        total_products = 0
