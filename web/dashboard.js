document.addEventListener('DOMContentLoaded', () => {
    ...
    const fetchDashboardData = async () => {
        ...
        if (!startDate || !endDate) { 
            showWarning("Datas necessárias", "Por favor, selecione um período de datas.", 3000);
            return; 
        }
        ...
        try {
            ...
            showSuccess("Dashboard atualizado", "Os dados do dashboard foram carregados com sucesso.", 3000);

        } catch (error) {
            console.error("Erro ao carregar dados do dashboard:", error);
            showError("Erro ao carregar", "Não foi possível carregar os dados do dashboard.", 5000);
        } finally {
