...
// Seleciona todos os mercados
function selectAllMarkets() {
    allMarkets.forEach(market => selectedMarkets.add(market.cnpj));
    renderMarketSelection(); // Re-render para atualizar a seleção
}

// Desmarca todos os mercados
...
document.addEventListener('DOMContentLoaded', async function() {
    ...
    // Adicionar event listeners para a busca de mercados
