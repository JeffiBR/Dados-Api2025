...
from dependencies import (
    get_current_user, UserProfile, require_page_access, 
    supabase, supabase_admin, APIError, calcular_data_expiracao,
    get_user_managed_groups, verify_group_admin_access, get_group_admin_user
)
